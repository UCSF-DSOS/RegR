...
Let's see what happens when we adjust for the polygenetic score for depression. First let's summarize this continuous variable.
...
**Visualize non-imputed vs. imputed**
...
```{r message=FALSE}
plot_summs(depfit_gen, depfit_gen_imp, scale=TRUE)
```
